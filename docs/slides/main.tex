...
\usepackage{pgf}
\logo{\pgfputat{\pgfxy(0,7.5)}{\pgfbox[right,base]{\includegraphics[height=1cm]{NCI_logo.png}}}}
...
\begin{outline}
    ...
    \2 All responded projects in Exascale Computing Projects\footnote{The US Department of Energy Ofﬁce of Science and the National Nuclear Security Administration initiated the Exascale
Computing Project (ECP) in 2016 to prepare mission-relevant applications and scientiﬁc software for the delivery of the
exascale computers starting in 2023.} use MPI.
\end{outline}
\end{frame}

\begin{frame}{A brief history of MPI standard}
\begin{outline}
\1 It has been around about 30 years.
\2 Work started in 1992
\2 Version 1.0 in 1994 - basic point-to-point, datatypes, collectives, etc
\2 Version 1.1 in 1995 - fixes and clarifications to MPI 1.0
\2 Version 1.2 in 1996 - fixes and clarifications to MPI 1.1
\2 Version 1.3 in 1997 - refers to MPI 1.2 after combination with MPI 2.0
\2 Version 2.0 in 1997 - parallel I/O, RMA, dynamic process, C++, etc
\2 Stable for 10 years
\2 Version 2.1 in 2008 - fixes and clarifications  to MPI 2.0
\2 Version 2.2 in 2009 - small updates  and additions to MPI 2.1
\2 Version 3.0 in 2012 - neighbour collectives, unified RMA model, etc
\2 Version 3.1 in 2015 - fixes and clarifications to MPI 3.0
\2 Version 4.0 in 2021 - large count, persistent collectives, partitioned communications, etc.

\footnotesize\textit{Courtesy of George Bosilca}
\end{outline}
\end{frame}
